  ...
  return (
    <Layout>
      ...
      <div className="container p-5 mx-auto -translate-y-12 xl:px-52 lg:px-52 lg:max-w-6xl">
        <div>
          <input style={{ width: '100%' }} onChange={onPostSearch} placeholder="Search blog posts..." className="px-5 py-2 my-2 text-lg border-2 border-black rounded-lg shadow-lg outline-none xl:w-96 lg:w-96 focus:border-purple-600" />
        </div>
