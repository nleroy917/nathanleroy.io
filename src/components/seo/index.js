...
const SEO = ({ post }) => {
  ...
  return (
    <Helmet>
      <meta name="description" content={post.blurb.raw[0].text} />
      <meta name="image" content={post.seo_image.url}/>
      <meta name="twitter:creator" content={twitterUsername} />
      <meta name="twitter:card" content="summary_with_image" />
      <meta name="twitter:title" content={post.title.raw[0].text} />
      <meta name="twitter:description" content={post.blurb.raw[0].text} />
      ...
      <meta property="og:title" content={post.title.raw[0].text} />
      <meta property="og:description" content={post.blurb.raw[0].text} />
