  ...
  return (
    <div className="border-b-2 border-black bg-gradient">
      <div className="h-screen max-w-full mx-auto lg:max-w-4xl xl:max-w-4xl md:max-w-100">
        <div
          className="flex flex-col items-center justify-center text-center lg:text-left xl:text-left lg:justify-center xl:justify-center lg:items-start xl:items-start"
          style={{ height: '90vh' }}>
          ...
          <div className="flex flex-row items-center justify-center space-x-4 lg:justify-start xl:justify-start xl:space-x-6">
            <div
              ...
              <p className="text-base font-bold hover:underline lg:text-xl">
                About me
                <span className="font-serif" style={{ fontSize: '0.7rem' }}>
                  ▼
                </span>
              </p>
              <div
                ...
                <ul className="text-base font-bold text-left list-none lg:text-lg xl:text-lg">
                  <li
                    onClick={() => {
                      anchors.bio.current.scrollIntoView();
                    }}
                  ...
                  <li
                    onClick={() => {
                      anchors.projects.current.scrollIntoView();
                    }}
                    className="p-1 hover:underline">
                    Projects
                  </li>
                  <li
                    onClick={() => {
                      anchors.contact.current.scrollIntoView();
                    }}
                    className="p-1 hover:underline">
                    Contact
                  </li>
              ...
              <div
                ...
                <ul className="text-base font-bold text-left list-none lg:text-lg xl:text-lg">
                  {projects.map((project, i) => (
                    <li className="p-1 hover:underline" key={i}>
                      <a className="text-black no-underline" href={project.node.data.github.url}>
                        {project.node.data.name.text}
                      </a>
                    </li>
                  ))}
                </ul>
            ...
            <div>
              <p className="font-bold transition-all cursor-pointer hover:underline xl:text-lg lg:text-xl">
                <a href={cv} target="_blank" className="text-black no-underline" rel="noreferrer">
                  CV
                </a>
              </p>
            </div>
            <Link to="/blog">
              <button className="px-8 py-1 text-lg text-white transition-all bg-transparent bg-black border-2 border-black rounded-lg shadow-md hover:bg-white hover:text-black">
                Blog
              </button>
            </Link>
          </div>
